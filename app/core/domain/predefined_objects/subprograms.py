...
SUBPROGRAMS: Final[list[Subprogram]] = [
    ...
    Subprogram(
        ...
        notifications=[
            ...
            Notification(
                name="N° 375",
                database_aliases=["N°:375.Du:26/02/2019.TRANCHE:1.Montant:   700 000"],
                aid_count=50,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            Notification(
                name="N° 705",
                database_aliases=["N°:705.Du:29/06/2020.TRANCHE:0.Montant:   700 000"],
                aid_count=600,
                aid_amount=700000,
            ),
            Notification(
                name="N° 1350",
                database_aliases=["N°:1350.Du:05/11/2020.TRANCHE:0.Montant:   700 000"],
                aid_count=600,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            Notification(
                name="N° 329",
                database_aliases=["N°:329.Du:02/02/2021.TRANCHE:0.Montant:   700 000"],
                aid_count=1500,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            Notification(
                name="N° 238",
                database_aliases=["N°:238.Du:26/03/2022.TRANCHE:0.Montant:   700 000"],
                aid_count=2500,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            Notification(
                name="N° 666",
                database_aliases=["N°:666.Du:06/08/2023.TRANCHE:0.Montant:   700 000"],
                aid_count=2000,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            ...
            Notification(
                name="N° 734",
                database_aliases=["N°:734.Du:30/07/2024.TRANCHE:0.Montant:   700 000"],
                aid_count=4000,
                aid_amount=700000,
            ),
        ],
    ...
    Subprogram(
        ...
        notifications=[
            Notification(
                name="N° 16",
                database_aliases=["N°:16.Du:06/01/2025.TRANCHE:0.Montant:   700 000"],
                aid_count=1000,
                aid_amount=700000,
            ),
        ],
